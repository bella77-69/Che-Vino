  ...
  return (
    <div  className="contact">
      ...
      <p className="contact-review">
        When it comes to wine, this can mean a few different things: learn more
        about wine, helping you chose better wine, record your tasting
        experiences, get a better deal/price for your plonk, find expert
        ratings, or pick the best vintage..
      </p>
      <p className="contact-time">posted 1 minute ago</p>
      ...
      <p className="contact-review">
        This is a critically-acclaimed free app that helps you get access to the
        world’s best wine. Keep track of your favorites and learn more about
        wine, Buy wines you love from your phone.
      </p>
      <p className="contact-time">posted 12 minute ago</p>
      <h4 className="contact-name">Kyle Smith</h4>
      <p className="contact-review">
        This app is a search engine for wine, containing price information of up
        to many million wine offers, and allowing to check for global
        availability of your favorite wine. You can use the label recognition to
        find the best place for buying.
      </p>
